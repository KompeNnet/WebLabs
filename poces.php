...
<body style="background-image:  url(sky.jpg); no-repeat;">

<form action="poces.php" method="POST">
    <h1 style="text-align:center; font-family:arial; color:white;font-size:30px;">
    Введите год: <input type="number" name="year" min="1970" >
...
if (isset($_POST['year'])) $year = $_POST['year'];
    else $year = date('Y'); //текущий год

$months = Array( 0 => 'Январь', 1 => 'Февраль', 2 => 'Март', 3 => 'Апрель', 4 => 'Май', 5 => 'Июнь', 6 => 'Июль',
                 7 => 'Август', 8 => 'Сентябрь', 9 => 'Октябрь', 10 => 'Ноябрь', 11 => 'Декабрь' );

for ($month = 1; $month <= 12; $month++) { ?>
    <div class="b-calendar b-calendar--many">
        <div class="b-calendar__title"><span class="b-calendar__month"><?php echo $months[$month-1]." $year"?></span> </div>
